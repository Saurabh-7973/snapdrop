...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Send photos straight into Figma'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Pick your photos, then scan that QR'**
  ...
  /// No description provided for @onboarding_note.
  ///
  /// In en, this message translates to:
  ...
  ///
  /// In en, this message translates to:
  /// **'Point at the code from your Figma plugin'**
  String get scan_subtitle;

  /// No description provided for @scan_help_link.
  ///
  /// In en, this message translates to:
  /// **'Where\'s the QR code?'**
  String get scan_help_link;

  /// No description provided for @qr_help_title.
  ///
  /// In en, this message translates to:
  /// **'Where\'s the QR code?'**
  String get qr_help_title;

  /// No description provided for @qr_help_step1.
  ///
  /// In en, this message translates to:
  /// **'Open Figma on your desktop computer.'**
  String get qr_help_step1;

  /// No description provided for @qr_help_step2.
  ///
  /// In en, this message translates to:
  /// **'Run the Snapdrop plugin — Menu > Plugins, or search \"Snapdrop\".'**
  String get qr_help_step2;

  /// No description provided for @qr_help_step3.
  ///
  /// In en, this message translates to:
  /// **'A QR code appears. Point your phone at it.'**
  String get qr_help_step3;

  /// No description provided for @qr_help_note.
  ///
  /// In en, this message translates to:
  /// **'It must be desktop Figma. The code is generated by the plugin, not this app.'**
  String get qr_help_note;

  /// No description provided for @qr_help_dismiss.
  ///
  /// In en, this message translates to:
  /// **'Got it'**
  String get qr_help_dismiss;
